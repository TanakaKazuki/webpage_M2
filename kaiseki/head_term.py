...
sitename_list = ['atarimae.biz','batapara.com','eman-physics.net','examist.jp','fromhimuka.com','hiraocafe.com','hooktail.sub.jp','manabitimes.jp','math-fun.net',
                 'math-juken.com','opencourse.doshisha.ac.jp','racco.mikeneko.jp','ramenhuhu.com','rikeilabo.com',
                 'tau.doshisha.ac.jp','ufcpp.net','univ-juken.com','univ-study.net','w3e.kanazawa-it.ac.jp',
                 'www.geisya.or.jp','www.maroon.dti.ne.jp','www.momoyama-usagi.com','www.sci.hokudai.ac.jp',
                 'yorikuwa.com']
...
for i in range(len(sitename_list)):
    ...
    df = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/html_data/correspondence_list_'+sitename+'.csv',header=None)
    filename = df[0]
    fileurl = df[1]
    ...
    for j in range(len(df[0])):
        ...
        df_file_head = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/head_data/'+sitename+'/head_'+filename+'.csv')
        #タイトルがあるなら
    ...
    df_output.to_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/head_data_site/'+sitename+"_header_term.csv",sep=',')
