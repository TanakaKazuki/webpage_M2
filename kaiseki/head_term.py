...
for i in range(len(sitename_list)):
    ...
    df = pd.read_csv('/Users/kazuki/Desktop/research/data_1619/kaiseki/html_data/correspondence_list_'+sitename+'.csv',header=None)
    filename = df[0]
    fileurl = df[1]
    ...
    for j in range(len(df[0])):
        ...
        df_file_head = pd.read_csv('/Users/kazuki/Desktop/research/data_1619/kaiseki/Headline_extraction/head_data/'+sitename+'/head_'+filename+'.csv')
        #タイトルがあるなら
